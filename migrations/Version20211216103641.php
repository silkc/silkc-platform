 ...
 */
final class Version20211216103641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE position ADD is_sent_to_affected_users TINYINT(1) DEFAULT \'0\' NOT NULL COMMENT \'Est-ce que le recruteur a déjà envoyé un email à tous les utilisateurs concernés par ce poste\', ADD sent_to_affected_users_at DATETIME DEFAULT NULL, CHANGE currency currency ENUM(\'euro\', \'złoty\'), CHANGE is_validated is_validated TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE is_rejected is_rejected TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE is_visible is_visible TINYINT(1) DEFAULT \'1\' NOT NULL');
