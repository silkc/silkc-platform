 ...
 */
final class Version20220407095651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_training ADD is_liked_by_me TINYINT(1) DEFAULT \'0\' NOT NULL, ADD is_disliked_by_me TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE is_followed is_followed TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE is_interesting_for_me is_interesting_for_me TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_occupation CHANGE is_current is_current TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE is_previous is_previous TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE is_desired is_desired TINYINT(1) DEFAULT \'0\' NOT NULL');
        $this->addSql('ALTER TABLE user_search CHANGE is_active is_active TINYINT(1) DEFAULT \'1\' NOT NULL');
        $this->addSql('ALTER TABLE user_training DROP is_liked_by_me, DROP is_disliked_by_me, CHANGE is_followed is_followed TINYINT(1) DEFAULT \'0\' NOT NULL, CHANGE is_interesting_for_me is_interesting_for_me TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
}
